...
if TYPE_CHECKING:
    from .api_wrapper import DiscordWrapper
...
class Commands:
    ...
    def __init__(self, config: ConfigManager) -> None:
        ...
        daily_lock = config.auto_daily
        sell_lock = config.auto_sell
...
class Scheduler:
    ...
    break_interval_values: tuple[float] = (60*60, 90*60) #A break can happen between 60 and 90 minutes
    break_duration_values: tuple[float] = (1*60, 2*60) #Each break takes 1 to 2 minutes
